...
import static configuration.TestRunProperties.getGridUrl;

public class BrowserFactory {
    private static final String MESSAGE_UNKNOWN_BROWSER = "Unknown browser type! Please check your eLeaderWeb.configuration";
    ...
    private WebDriver getRemoteWebDriver(DesiredCapabilities desiredCapabilities) {
        ...
        try {
            remoteWebDriver = new RemoteWebDriver(new URL(getGridUrl()), desiredCapabilities);
